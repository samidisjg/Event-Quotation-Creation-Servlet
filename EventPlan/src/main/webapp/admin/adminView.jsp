...
<body>
	...
	<!-- <i class='bx bx-code-alt'></i> -->
			...
			<div class="logo-name">
				<span>Master</span>Mind
			</div>
		
		<ul class="side-menu">
			<li><a href="#"><i class='bx bxs-dashboard'></i>Dashboard</a></li>
			<li><a href="index2.jsp"><i class='bx bx-store-alt'></i>Home</a></li>
	...
	<div class="content">
		...
		<main>
			...
			<!-- Insights -->
			<ul class="insights">
				<a href="admin/addPackages.jsp"><li><i class="fas fa-plus-square fa-3x text-primary"></i> <span class="info">
						<h3>Add Packages</h3>
				</span></li></a>
				<a href="admin/allPackages.jsp"><li><i class="fas fa-gift fa-3x text-danger"></i> <span class="info">
						<h3>All Packages</h3>
				</span></li></a>
			</ul>
			<!-- End of Insights -->
